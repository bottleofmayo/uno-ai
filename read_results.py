...
print(f"Random mean: {df.loc[df['P1'] == 'Random', 'P1 Score'].mean()}")
print(f"Rule Model mean: {df.loc[df['P1'] == 'Rule Model', 'P1 Score'].mean()}")
...
print(f"Random std: {df.loc[df['P1'] == 'Random', 'P1 Score'].std()}")
print(f"Rule Model std: {df.loc[df['P1'] == 'Rule Model', 'P1 Score'].std()}")
...
print(f"Random std error: {df.loc[df['P1'] == 'Random', 'P1 Score'].std()/math.sqrt(len(df.loc[df['P1'] == 'Random', 'P1 Score']))}")
print(f"Rule Model std error: {df.loc[df['P1'] == 'Rule Model', 'P1 Score'].std()/math.sqrt(len(df.loc[df['P1'] == 'Rule Model', 'P1 Score']))}")
